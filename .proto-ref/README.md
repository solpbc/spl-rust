...
This directory is a read-only mirror of the six protocol documents consumed by `spl-rust` from <https://github.com/solpbc/spl/tree/main/proto>, pinned at commit `42bdb218001899f55f5bf767ee740540868d63e9`.

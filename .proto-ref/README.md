...
This directory is a read-only mirror of the six protocol documents consumed by `spl-rust` from <https://github.com/solpbc/spl/tree/main/proto>, pinned at commit `7266d9d91c2eb0867ae512a7ea3f3dd001a9ae45`.

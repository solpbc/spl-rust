...
This directory is a read-only mirror of the six protocol documents consumed by `spl-rust` from <https://github.com/solpbc/spl/tree/main/proto>, pinned at commit `bc0eec0ac4230df023abb0d88bee812358b3fe60`.
